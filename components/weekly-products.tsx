...
export function WeeklyProducts({ limit = 8 }) {
  ...
  const handleCardQuantityChange = (productId: string, newQuantity: number) => {
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {displayProducts.map((product: any) => {
            const currentCardQuantity = cardQuantities[product.id] || 1;
            return (
              <div
                key={product.id}
              ...
              >
                ...
                <div className="flex items-center justify-between">
                  <div className="flex items-center border border-gray-300 rounded">
                    <button onClick={() => handleCardQuantityChange(product.id, currentCardQuantity - 1)} className="px-2 py-1 text-gray-500 hover:text-gray-700 text-sm">-</button>
                  ...
                  <button
                    ...
                    onClick={() => addToCart(product, currentCardQuantity)}
                  >
