...
const formatImagePath = (filename: string | undefined): string => {
  ...
  // If it's already a full URL (http/https) or already starts with /images/, return as is
                  ...
                  <div className="aspect-square mb-4 bg-gray-50 rounded-lg flex items-center justify-center overflow-hidden">
                    {Array.isArray(product.image) ? (
                      <picture>
                        ...
                        <img
                          src={formatImagePath(product.image[1]) || "/placeholder.jpg"}
                          alt={product.name}
                          width={150}
                          height={150}
                      ...
                      <Image
                        src={formatImagePath(product.image || "/placeholder.jpg")}
                        alt={product.name}
                        width={150}
                        height={150}
                        className="w-full h-full object-contain rounded-lg group-hover:scale-105 transition-transform"
